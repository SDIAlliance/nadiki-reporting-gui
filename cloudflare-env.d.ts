/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: b7eee001a7c7e34a1b712d09d9992c0e)
// Runtime types generated with workerd@1.20250604.0 2024-12-09 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		REGISTRAR_API_BASE_URL: string;
		FACILITY_API_SPEC_URL: string;
		RACK_API_SPEC_URL: string;
		SERVER_API_SPEC_URL: string;
